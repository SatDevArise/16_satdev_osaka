...
<html>
	...
	<body>
    	...
    	<form:form modelAttribute="SIJGM002Form">
    		...
    		<p>社員ID：<input type = "text" name = "社員ID"></p>

			<form:input path="name"/>
			<p>氏名：<input type = "text" name = "氏名">
    		   生年月日：<input type ="text" name = "生年月日"></p>

    		<form:input path="moyori_1_station,moyori_2_station,moyori_3_station"/>
    		<p>最寄り駅：<input type = "text" name = "最寄り駅">
    					 <input type = "text" name = "最寄り駅2">
    					 <input type = "text" name = "最寄り駅3"></p>
    		<p>
    		連絡先：<input type = "text" name = "連絡先"></p>
    		<p>
    		...
    		<p>
    		チーム：<input type = "text" name = "チーム"></p>
    		<p>
    		フェーズ：<input type = "text" name = "フェーズ">
    		単価：<input type = "text" name = "単価"></p>
    		<p>
    		現場名：<input type = "text" name = "現場名"></p>
    		<p>
    		参画日：<input type = "text" name = "参画日"></p>
